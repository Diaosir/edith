...
import { URI } from './uri';
import { sep, posix, normalize, win32 } from './path';
import { endsWith, startsWithIgnoreCase, rtrim, startsWith } from './strings';
import { Schemas } from './network';
import { isLinux, isWindows, isMacintosh } from './platform';
import { isEqual, basename, relativePath } from './resources';
