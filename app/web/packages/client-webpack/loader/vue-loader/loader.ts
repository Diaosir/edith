...
import componentNormalizerRaw from './runtime/componentNormalizer';
import vueHotReloadAPIRaw from 'vue-hot-reload-api';
...
export default function(content: string, path: string, options: any) {
  let query: any = {}
  options = {
        ...options,
        esModule: false
